...
public class GuiMainMenu extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        changes.add("");
        changes.add("Build 220519");
        changes.add("+New Verify");
        changes.add("+BlocksMC AntiVoid");
        ...
        Fonts.SFUI35.drawString("Noteless Client(#Build 220520)", 4f, height - 12f, new Color(255, 255, 255, 200).getRGB(), true);
