...
@ModuleInfo(name = "NoFall", category = ModuleCategory.PLAYER, description = "skid")
class NoFall : Module() {
    val modeValue = ListValue("Mode", arrayOf("SpoofGround", "AlwaysSpoofGround", "NoGround", "Packet", "Packet1", "Packet2", "MLG", "OldAAC", "LAAC", "AAC3.3.11", "AAC3.3.15", "AACv4", /*"AAC5.0.4", */"AAC5.0.14", "Spartan", "CubeCraft", "BlocksMC", "HypSpoof", "Verus", "Damage", "MotionFlag",/*"OldMatrix", */ "Matrix", "MatrixPacket"), "SpoofGround")
    ...
    fun onUpdate(event: UpdateEvent) {
        ...
        if (BlockUtils.collidelock(mc.thePlayer.entityBoundingBox) { it is BlockLiquid } || BlockUtils.collidelock(AxisAlignedBB(mc.thePlayer.entityBoundingBox.maxX, mc.thePlayer.entityBoundingBox.maxY, mc.thePlayer.entityBoundingBox.maxZ, mc.thePlayer.entityBoundingBox.minX, mc.thePlayer.entityBoundingBox.minY - 0.01, mc.thePlayer.entityBoundingBox.minZ)) { it is BlockLiquid }) {
            return
        }
